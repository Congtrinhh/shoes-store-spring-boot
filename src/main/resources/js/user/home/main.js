...
const listWrapper = document.querySelector(".new-arrivals .products");
const leftBtn = document.querySelector(".controller-container .left");
const rightBtn = document.querySelector(".controller-container .right");
