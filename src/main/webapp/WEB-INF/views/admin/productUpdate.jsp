...
<body>
	...
	<div id="app">
		...
		<main class="content">
			<div class="form-header create-area__header">Tạo dòng sản phẩm
				mới</div>
			<form id='createForm' action='${base }/admin/product/${product.id}'
				...
				<div class="fieldsets">
					...
					<fieldset>
						<div class="">
							<div class="form-header">
								<span>Hãng: ${product.brand.name}</span>
					...
					<fieldset>
						<div class="">
							<div class="form-header">
								<span>Phân loại: ${product.category.name}</span>
								<button class="btn btn-edit">
									<i class="far fa-edit"></i>
								</button>
							</div>
					...
					<fieldset>
						...
						<div class="image-upload-container">
							<p>
								Thêm ảnh mới (định dạng <b>jpg</b>, <b>png</b>, <b>jpeg</b>, tối
								đa <b>6</b> ảnh)
							</p>
