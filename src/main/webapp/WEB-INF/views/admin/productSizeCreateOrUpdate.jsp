...
<title>Sản phẩm size - thêm - cập nhật</title>
...
<link rel="stylesheet"
	href="${base}/css/admin/productSizeCreateOrUpdate/style.css">
<script defer src="${base}/js/common/utils.js"></script>
<script defer src="${base}/js/admin/lib/adminSidebar.js"></script>
<script defer src="${base}/js/admin/productSizeCreateOrUpdate/main.js"></script>
...
<body>
	...
	<div id="app">
		...
		<main class="content">
			...
			<c:set value="${productSize.id != null ? 'Sửa item' : 'Thêm item'}" var="headerText" />
			<div class="form-header create-area__header">
				<c:out value="${headerText }"/>
				<c:if test="${productSize.id != null}">
				<!-- nút tạo mới -->
				<div class="new">
			...
			<form:form id="createForm"
				action="${base }/admin/product-size/create-or-update" method="post"
				...
				<div class="wrapper">
						<div class="form-text">
							...
							<label for="" class="label-name">
								<p class="content-name__placeholder">Số lượng</p>
							</label> <span></span>
						</div>
					...
					<div class="wrapper">
						<div class="form-text">
							<form:input path="discountPercent" required="required" />
							<label for="" class="label-name">
								<p class="content-name__placeholder">Phần trăm giảm giá</p>
							</label> <span></span>
						</div>
					</div>
				...
				<div class="fieldsets">
					...
					<fieldset>
						<div class="">
							<div class="form-header">Sản phẩm</div>
							<form:select path="product.id" required="required">
					...
					<fieldset>
						<div class="">
							<div class="form-header">Size</div>
							<form:select path="size.id" required="required">
								<option value="">-- Chọn size --</option>
								<form:options items="${sizes}" itemValue="id"
									itemLabel="sizeNo" />
							</form:select>
						</div>
					</fieldset>
