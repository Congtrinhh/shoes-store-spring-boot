...
<title>Brand - thêm - cập nhật</title>
<!-- Jquery -->
<script
...
<link rel="stylesheet"
	href="${base}/css/admin/brandCreateOrUpdate/style.css">
<script defer src="${base}/js/common/utils.js"></script>
<script defer src="${base}/js/admin/lib/adminSidebar.js"></script>
<script defer src="${base}/js/admin/brandCreateOrUpdate/main.js"></script>
...
<body>
	...
	<div id="app">
		...
		<main class="content">
			...
			<c:set value="${brand.id != null ? 'Sửa sản phẩm' : 'Thêm sản phẩm'}" var="headerText" />
			...
			<form:form id="createForm"
				action="${base }/admin/brand/create-or-update" method="post"
				enctype="multipart/form-data" modelAttribute="brand">
					...
					<div class="wrapper">
						...
						<div class="form-text">
							...
							<label for="" class="label-name">
								<p class="content-name__placeholder">Tên hãng</p>
							</label> <span></span>
						</div>
