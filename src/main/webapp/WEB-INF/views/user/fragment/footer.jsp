			...
			<div class="">
				<p class="footer__sub-header mb-0">
					...
					<a
						...
						href="#footer__sub-content-1"
						role="button"
						aria-expanded="false"
						aria-controls="footer__sub-content-1"
			...
			<div class="">
				<p class="footer__sub-header">
					...
					<a
						class="d-inline-block d-sm-none"
						data-bs-toggle="collapse"
						href="#footer__sub-content-2"
						role="button"
						aria-expanded="false"
						aria-controls="footer__sub-content-2"
						><i class="fas fa-plus"></i
					></a>
				</p>
			...
			<div class="">
				<p class="footer__sub-header">
					...
					<a
						class="d-inline-block d-sm-none"
						data-bs-toggle="collapse"
						href="#footer__sub-content-3"
						role="button"
						aria-expanded="false"
						aria-controls="footer__sub-content-3"
						><i class="fas fa-plus"></i
					></a>
				</p>
...
<a class="back-to-top btn" id="${login_token}"><i class="fas fa-caret-up"></i></a>
